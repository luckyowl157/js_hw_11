...
var PNotify = __webpack_require__(610);
// EXTERNAL MODULE: ./node_modules/@pnotify/mobile/dist/PNotifyMobile.js
var PNotifyMobile = __webpack_require__(810);
...
var dist_PNotify = __webpack_require__(306);
...
var Angeler = __webpack_require__(131);
...
var BrightTheme = __webpack_require__(578);
...
var Material = __webpack_require__(329);
...
var Country = /*#__PURE__*/function () {
  function Country(uri) {
    var _this = this;

    _classCallCheck(this, Country);

    _defineProperty(this, "fetchCountry", function () {
      var query = "".concat(_this.inputValue);
      var url = _this.uri + "/" + query;
        ...
        if (data.length > 2) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var countriesList = document.createElement('li');
              var countriesFlag = document.createElement('span');
              countriesList.className = 'countries';
              countriesList.textContent = country.name.common;
              var flags = country.flag;
              countriesFlag.append(flags);
              countriesList.append(countriesFlag);

              _this.result.append(countriesList);
          ...
          var dataRes = data[0]; // console.log('data', dataRes);

          var li = document.createElement("li");
          var p = document.createElement('p');
          var span = document.createElement('span');
          var spanCapital = document.createElement('span');
          var spanLang = document.createElement('span');
          p.textContent = dataRes.name.common;
          spanCapital.textContent = "Capital: " + dataRes.capital;
          spanLang.textContent = "Language: " + Object.values(dataRes.languages); // console.log('Cap', spanCapital);
          ...
          _this.result.append(li);

          return _this.result;
        }
      })["catch"](function (err) {
        _this.renderError(err); // console.log('qweeee',err);
    ...
    _defineProperty(this, "onInputChange", function (event) {
      ...
      var lowName = _this.inputValue = inputValue.toLowerCase();

      _this.fetchCountry();
    });

    _defineProperty(this, "loadListeners", function () {
      _this.input.addEventListener("input", debounce(_this.onInputChange, 500));
    });
...
var URI = "https://restcountries.com/v3/name";
new Country(URI).init();
/* harmony default export */ const countries = ({
  alert: PNotify.alert,
...
var src_debounce = __webpack_require__(296);
